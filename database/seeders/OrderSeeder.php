        ...
        foreach ($orders as $index => $demo) {
            ...
            $order = Order::updateOrCreate(
                ...
                [
                    ...
                    'stripe_checkout_session_id' => 'cs_test_demo_'.$demo['number'],
                    'stripe_payment_intent_id' => $demo['payment_status'] === 'paid' ? 'pi_test_demo_'.$demo['number'] : null,
                    'stripe_payment_status' => $demo['payment_status'] === 'paid' ? 'paid' : $demo['payment_status'],
                    'paid_at' => $demo['payment_status'] === 'paid' ? $demo['placed_at']->copy()->addMinutes(2) : null,
                    'payment_cancelled_at' => $demo['payment_status'] === 'cancelled' ? $demo['placed_at']->copy()->addMinutes(5) : null,
